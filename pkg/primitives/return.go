...
var _ primitive_types.Primitive = &Return{}
var _ primitive_types.BlockErrorResultHandler = &Return{}
...
func (r *Return) HandleBlockErrorResult(err error, i primitive_types.Interpreter, destination *parsers.PropertyRef, block []*parsers.Instruction) (interface{}, error) {
