...
var (
	...
	// Tokenizer errors
	ErrTokenizerNotFound = errors.New("tokenizer: tokenizer file not found")
	ErrVocabNotLoaded    = errors.New("tokenizer: vocabulary not loaded")
	ErrUnknownToken      = errors.New("tokenizer: unknown token encountered")
	ErrUnknownTokenID    = errors.New("tokenizer: unknown token ID")
	ErrSequenceTooLong   = errors.New("tokenizer: token sequence exceeds maximum length")
	ErrVocabRead         = errors.New("tokenizer: failed to read vocabulary file")
	ErrVocabParse        = errors.New("tokenizer: failed to parse vocabulary file")
	ErrMergesRead        = errors.New("tokenizer: failed to read merges file")
	ErrSpecialRead       = errors.New("tokenizer: failed to read special tokens file")
	ErrSpecialParse      = errors.New("tokenizer: failed to parse special tokens file")
)
