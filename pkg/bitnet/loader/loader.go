...
var (
	ErrFSNotSet      = errors.New("loader: filesystem cannot be nil")
	ErrPathEmpty     = errors.New("loader: model path cannot be empty")
	ErrModelNotFound = errors.New("loader: model file not found")
	ErrInvalidGGUF   = errors.New("loader: invalid GGUF file format")
	ErrModelNotSet   = errors.New("loader: model path not set")
	ErrReaderNil     = errors.New("loader: reader cannot be nil")
)
